		...
		<div class="col-md-12">
          ...
          <form  method="post" action="{{ route('pengurus.update', $pengurus->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="judul_slide">Nama Pengurus</label>
              <input type="text" name="nama_pengurus" class="form-control" id="text" value="{{ $pengurus->nama_pengurus }}">
            </div>
            <div class="form-group">
              <label for="judul_slide">Jabatan</label>
              <input type="text" name="jabatan" class="form-control" id="text" value="{{ $pengurus->jabatan }}">
            </div>
            <div class="form-group">
              ...
              <img src="{{ asset('uploads/' .$pengurus->gambar_pengurus) }}" width="30%">
            </div>
